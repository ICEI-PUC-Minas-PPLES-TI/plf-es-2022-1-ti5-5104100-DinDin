...
describe("PUT wallet/:id/transaction/:tid  test suite", ()=>{
    it("should update the trasaction", async () => {
        ...
        const createResponse = await request.post(url("/transaction")).send(mockTransaction);
    ...
    it("should not update a transaction with long description", async () => {
        ...
        mockTransaction.description = "this is a long, very long, absolety long description";
