    ...
    >
        <v-card class="pa-2">
            <v-card-title class="text-h5 wallets-modal-title">
                <h4>
                    <span>
                        {{ walletToEdit ? "Edit Wallet" : "New Wallet" }}</span
                    >
                </h4>
            ...
            <v-card-actions>
                <v-row>
                    ...
                    <v-col v-if="walletToEdit != null" class="mr-2">
                        <v-btn block color="primary" @click.stop="editWallet()"
                            >Edit</v-btn
                        >
                    </v-col>
                    <v-col v-else class="mr-2">
                        <v-btn block color="primary" @click.stop="saveWallet()"
                            >Save</v-btn
                        >
                    </v-col>
                </v-row>
